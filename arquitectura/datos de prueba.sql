-- Datos que se pueden utilizar en una nueva instancia del programa para pruebas locales
-- Ejecutar despues de haber creado las tablas e insertado los datos fundamentales
